// backend/utils/courseRecommendationsUtils.cjs
...
const getEffectiveTypeForProgrammeClient = (
  course,
  programmeCode,
  programmeId,
  studentDepartment
  ...
  // 2) No override: special programme_elective rules
  ...
  // 3) Everything else: keep raw type
  return rawType;
};

const isFollowingDefaultSoFar = (
  entries,
  allCourses,
  mapping,
